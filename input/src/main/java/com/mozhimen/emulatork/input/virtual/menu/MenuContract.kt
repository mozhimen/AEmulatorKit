...
object MenuContract {
    ...
    const val EXTRA_SYSTEM_CORE_BUNDLE = "EXTRA_SYSTEM_CORE_CONFIG"
    const val EXTRA_CURRENT_DISK = "EXTRA_CURRENT_DISK"
    const val EXTRA_AVAILABLE_DISKS = "EXTRA_DISKS"
    const val EXTRA_SYSTEM_OPTIONS = "EXTRA_CORE_OPTIONS"
    const val EXTRA_SYSTEM_OPTIONS_ADVANCED = "EXTRA_ADVANCED_CORE_OPTIONS"
