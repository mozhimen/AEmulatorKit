...
import com.mozhimen.emulatork.test.feature.input.inputclass.getInputClass
...
import com.mozhimen.emulatork.test.shared.coreoptions.CoreOption
...
import com.mozhimen.emulatork.util.coroutines.MutableStateProperty
...
import com.mozhimen.emulatork.util.graphics.takeScreenshot
import com.mozhimen.emulatork.util.kotlin.NTuple2
import com.mozhimen.emulatork.util.kotlin.NTuple4
import com.mozhimen.emulatork.util.kotlin.filterNotNullValues
import com.mozhimen.emulatork.util.kotlin.toIndexedMap
import com.mozhimen.emulatork.util.kotlin.zipOnKeys
import com.mozhimen.emulatork.util.xml.animationDuration
import com.mozhimen.emulatork.util.xml.displayToast
import com.mozhimen.emulatork.util.xml.dump
...
abstract class BaseGameActivity : ImmersiveActivity() {
    ...
    private fun displayLoadingState(loadingState: GameLoader.LoadingState) {
        loadingMessageStateFlow.value = when (loadingState) {
            is GameLoader.LoadingState.LoadingCore -> getString(com.mozhimen.emulatork.ext.R.string.game_loading_download_core)
    ...
    private fun displayGameLoaderError(gameError: GameLoaderError, coreConfig: SystemCoreConfig) {
        ...
        val messageId = when (gameError) {
            ...
            is GameLoaderError.LoadCore -> getString(com.mozhimen.emulatork.ext.R.string.game_loader_error_load_core)
