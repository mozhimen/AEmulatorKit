...
class InputBindingUpdater(private val inputDeviceManager: com.mozhimen.emulatork.ui.input.InputDeviceManager, intent: Intent) {
    ...
    private fun onKeyUp(event: KeyEvent): Boolean {
        ...
        runBlocking {
            GlobalScope.async {
                inputDeviceManager.updateBinding(event.device, com.mozhimen.emulatork.ui.input.RetroKey(extras.retroKey), com.mozhimen.emulatork.ui.input.InputKey(event.keyCode))
            }
        }
