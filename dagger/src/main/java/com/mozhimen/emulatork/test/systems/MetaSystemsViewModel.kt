...
class MetaSystemsViewModel(retrogradeDb: RetrogradeDatabase, appContext: Context) : ViewModel() {
    ...
    val availableMetaSystems: Flow<List<com.mozhimen.emulatork.ui.systems.MetaSystemInfo>> = retrogradeDb.gameDao()
        ...
        .map { systemCounts ->
            systemCounts.asSequence()
                ...
                .map { (metaSystemId, counts) -> com.mozhimen.emulatork.ui.systems.MetaSystemInfo(metaSystemId, counts.sumBy { it.second }) }
