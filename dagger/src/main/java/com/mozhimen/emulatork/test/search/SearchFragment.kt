 ...
 * @Version 1.0
 */
class SearchFragment : com.mozhimen.emulatork.ui.game.RecyclerViewFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val gamesAdapter = com.mozhimen.emulatork.ui.game.GamesAdapter(R.layout.layout_game_list, gameInteractor, coverLoader)
