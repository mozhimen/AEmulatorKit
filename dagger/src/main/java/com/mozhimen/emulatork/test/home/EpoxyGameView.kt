package com.mozhimen.emulatork.test.home
...
import com.mozhimen.emulatork.ui.game.GameContextMenuListener
import com.mozhimen.emulatork.ui.game.GameInteractor
import com.mozhimen.emulatork.ui.covers.CoverLoader
import com.mozhimen.emulatork.ui.game.GameUtils
...
abstract class EpoxyGameView : EpoxyModelWithHolder<EpoxyGameView.Holder>() {
    ...
    override fun bind(holder: Holder) {
        ...
        holder.subtitleView?.let { it.text = com.mozhimen.emulatork.ui.game.GameUtils.getGameSubtitle(it.context, game) }
        ...
        holder.itemView?.setOnCreateContextMenuListener(
            com.mozhimen.emulatork.ui.game.GameContextMenuListener(gameInteractor, game)
        )
    }
