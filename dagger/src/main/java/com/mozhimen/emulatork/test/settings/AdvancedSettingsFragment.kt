...
class AdvancedSettingsFragment : PreferenceFragmentCompat() {
    ...
    @Inject
    lateinit var settingsInteractor: com.mozhimen.emulatork.ui.settings.SettingsInteractor
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        com.mozhimen.emulatork.ui.settings.AdvancedSettingsPreferences.updateCachePreferences(preferenceScreen)
    }
