package com.mozhimen.emulatork.test.main
...
import com.mozhimen.emulatork.ui.dagger.android.RetrogradeAppCompatActivity
...
import com.mozhimen.emulatork.ui.BaseGameActivity
...
class MainActivity : RetrogradeAppCompatActivity(), com.mozhimen.emulatork.ui.main.BusyActivity {

    @Inject
    lateinit var gameLaunchTaskHandler: com.mozhimen.emulatork.ui.main.GameLaunchTaskHandler
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            com.mozhimen.emulatork.ui.BaseGameActivity.REQUEST_PLAY_GAME -> {
                GlobalScope.launchSafe {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.menu_options_sync -> {
                com.mozhimen.emulatork.ui.savesync.SaveSyncWork.enqueueManualWork(this)
                true
            }
    ...
    abstract class Module {
        ...
        companion object {
            ...
            fun settingsInteractor(activity: MainActivity, directoriesManager: DirectoriesManager) =
                com.mozhimen.emulatork.ui.settings.SettingsInteractor(activity, directoriesManager)

            @Provides
            @PerActivity
            @JvmStatic
            fun gamePadPreferencesHelper(inputDeviceManager: com.mozhimen.emulatork.ui.input.InputDeviceManager) =
                com.mozhimen.emulatork.ui.settings.GamePadPreferencesHelper(inputDeviceManager, false)
            ...
            fun gameInteractor(
                ...
                shortcutsGenerator: com.mozhimen.emulatork.ui.shortcuts.ShortcutsGenerator,
                gameLauncher: com.mozhimen.emulatork.ui.game.GameLauncher
            ) =
                com.mozhimen.emulatork.ui.game.GameInteractor(activity, retrogradeDb, false, shortcutsGenerator, gameLauncher)
        }
    }
}
