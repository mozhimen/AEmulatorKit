...
import com.mozhimen.emulatork.basic.dagger.core.CoreVariablesManager
...
import com.mozhimen.emulatork.ui.game.ExternalGameLauncherActivity
...
abstract class LemuroidApplicationModule {
    ...
    abstract fun externalGameLauncherActivity(): com.mozhimen.emulatork.ui.game.ExternalGameLauncherActivity

    @PerActivity
    @ContributesAndroidInjector
    abstract fun gameActivity(): com.mozhimen.emulatork.ui.game.GameActivity

    @PerActivity
    @ContributesAndroidInjector(modules = [com.mozhimen.emulatork.ui.gamemenu.GameMenuActivity.Module::class])
    abstract fun gameMenuActivity(): com.mozhimen.emulatork.ui.gamemenu.GameMenuActivity

    @PerActivity
    @ContributesAndroidInjector
    abstract fun storageFrameworkPickerLauncher(): com.mozhimen.emulatork.ui.settings.StorageFrameworkPickerLauncher
    ...
    companion object {
        ...
        fun inputDeviceManager(context: Context, sharedPreferences: Lazy<SharedPreferences>) =
            com.mozhimen.emulatork.ui.input.InputDeviceManager(context, sharedPreferences)
        ...
        @PerApp
        @JvmStatic
        fun biosPreferences(biosManager: BiosManager) = com.mozhimen.emulatork.ui.settings.BiosPreferences(biosManager)
        ...
        @PerApp
        @JvmStatic
        fun coreSelectionPreferences() = com.mozhimen.emulatork.ui.settings.CoresSelectionPreferences()
        ...
        fun postGameHandler(retrogradeDatabase: RetrogradeDatabase) =
            com.mozhimen.emulatork.ui.main.GameLaunchTaskHandler(ReviewManager(), retrogradeDatabase)

        @Provides
        @PerApp
        @JvmStatic
        fun shortcutsGenerator(context: Context, retrofit: Retrofit) =
            com.mozhimen.emulatork.ui.shortcuts.ShortcutsGenerator(context, retrofit)
...
//            ChannelHandler(context, retrogradeDatabase, retrofit)
        ...
        fun retroControllerManager(sharedPreferences: Lazy<SharedPreferences>) =
            com.mozhimen.emulatork.ui.settings.ControllerConfigsManager(sharedPreferences)

        @Provides
        @PerApp
        @JvmStatic
        fun settingsManager(context: Context, sharedPreferences: Lazy<SharedPreferences>) =
            com.mozhimen.emulatork.ui.settings.SettingsManager(context, sharedPreferences)
        ...
        fun gameLauncher(
            ...
            gameLaunchTaskHandler: com.mozhimen.emulatork.ui.main.GameLaunchTaskHandler
        ) =
            com.mozhimen.emulatork.ui.game.GameLauncher(coresSelection, gameLaunchTaskHandler)
        ...
        fun rumbleManager(
            context: Context,
            settingsManager: com.mozhimen.emulatork.ui.settings.SettingsManager,
            inputDeviceManager: com.mozhimen.emulatork.ui.input.InputDeviceManager
        ) =
            com.mozhimen.emulatork.ui.rumble.RumbleManager(context, settingsManager, inputDeviceManager)
        ...
        fun coverLoader(
            context: Context
        ) = com.mozhimen.emulatork.ui.covers.CoverLoader(context)
    }
}
