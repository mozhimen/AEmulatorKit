 ...
 * @Version 1.0
 */
class InputDeviceKeyboard(private val device: InputDevice) : com.mozhimen.emulatork.input.device.InputDevice {

    override fun getCustomizableKeys(): List<InputRetroKey> = InputDeviceManager.OUTPUT_KEYS
    ...
    companion object {
        ...
        private val DEFAULT_BINDINGS = bindingsOf(
