...
/**
 * @ClassName LemuroidTouchConfigs
 * @Description TODO
...
object InputConfigs {
    ...
    fun getRadialGamePadConfig(
        ...
        val radialGamePadConfig = when (kind) {
            InputKind.GB_LEFT -> getGBLeft(theme)
            InputKind.GB_RIGHT -> getGBRight(theme)
            InputKind.NES_LEFT -> getNESLeft(theme)
            InputKind.NES_RIGHT -> getNESRight(theme)
            InputKind.DESMUME_LEFT -> getDesmumeLeft(theme)
            InputKind.DESMUME_RIGHT -> getDesmumeRight(theme)
            InputKind.MELONDS_NDS_LEFT -> getMelondsLeft(theme)
            InputKind.MELONDS_NDS_RIGHT -> getMelondsRight(theme)
            InputKind.PSX_LEFT -> getPSXLeft(theme)
            InputKind.PSX_RIGHT -> getPSXRight(theme)
            InputKind.PSX_DUALSHOCK_LEFT -> getPSXDualshockLeft(theme)
            InputKind.PSX_DUALSHOCK_RIGHT -> getPSXDualshockRight(theme)
            InputKind.PSP_LEFT -> getPSPLeft(theme)
            InputKind.PSP_RIGHT -> getPSPRight(theme)
            InputKind.SNES_LEFT -> getSNESLeft(theme)
            InputKind.SNES_RIGHT -> getSNESRight(theme)
            InputKind.GBA_LEFT -> getGBALeft(theme)
            InputKind.GBA_RIGHT -> getGBARight(theme)
            InputKind.SMS_LEFT -> getSMSLeft(theme)
            InputKind.SMS_RIGHT -> getSMSRight(theme)
            InputKind.GG_LEFT -> getGGLeft(theme)
            InputKind.GG_RIGHT -> getGGRight(theme)
            InputKind.LYNX_LEFT -> getLynxLeft(theme)
            InputKind.LYNX_RIGHT -> getLynxRight(theme)
            InputKind.PCE_LEFT -> getPCELeft(theme)
            InputKind.PCE_RIGHT -> getPCERight(theme)
            InputKind.DOS_LEFT -> getDOSLeft(theme)
            InputKind.DOS_RIGHT -> getDOSRight(theme)
            InputKind.NGP_LEFT -> getNGPLeft(theme)
            InputKind.NGP_RIGHT -> getNGPRight(theme)
            InputKind.WS_LANDSCAPE_LEFT -> getWSLandscapeLeft(theme)
            InputKind.WS_LANDSCAPE_RIGHT -> getWSLandscapeRight(theme)
            InputKind.WS_PORTRAIT_LEFT -> getWSPortraitLeft(theme)
            InputKind.WS_PORTRAIT_RIGHT -> getWSPortraitRight(theme)
            InputKind.N64_LEFT -> getN64Left(theme)
            InputKind.N64_RIGHT -> getN64Right(theme)
            InputKind.GENESIS_3_LEFT -> getGenesis3Left(theme)
            InputKind.GENESIS_3_RIGHT -> getGenesis3Right(theme)
            InputKind.GENESIS_6_LEFT -> getGenesis6Left(theme)
            InputKind.GENESIS_6_RIGHT -> getGenesis6Right(theme)
            InputKind.ATARI2600_LEFT -> getAtari2600Left(theme)
            InputKind.ATARI2600_RIGHT -> getAtari2600Right(theme)
            InputKind.ARCADE_4_LEFT -> getArcade4Left(theme)
            InputKind.ARCADE_4_RIGHT -> getArcade4Right(theme)
            InputKind.ARCADE_6_LEFT -> getArcade6Left(theme)
            InputKind.ARCADE_6_RIGHT -> getArcade6Right(theme)
            InputKind.ATARI7800_LEFT -> getAtari7800Left(theme)
            InputKind.ATARI7800_RIGHT -> getAtari7800Right(theme)
            InputKind.NINTENDO_3DS_LEFT -> getNintendo3DSLeft(theme)
            InputKind.NINTENDO_3DS_RIGHT -> getNintendo3DSRight(theme)
        }
