...
object CacheCleaner {
    ...
    suspend fun clean(
        ...
        val cacheFoldersSequence = sequenceOf(
            File(appContext.cacheDir, StorageDirProvider.SAF_CACHE_SUBFOLDER).walkBottomUp(),
            File(appContext.cacheDir, StorageDirProvider.LOCAL_STORAGE_CACHE_SUBFOLDER).walkBottomUp()
        )
