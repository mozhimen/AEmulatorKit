...
class SaveStateManager(private val storageDirectoriesManager: StorageDirectoriesManager) {
    ...
    private fun getStateFile(fileName: String, coreName: String): File {
        val statesDirectories = File(storageDirectoriesManager.getStatesDirectory(), coreName)
    ...
    private fun getDeprecatedStateFile(fileName: String): File {
        val statesDirectories = storageDirectoriesManager.getInternalStatesDirectory()
        return File(statesDirectories, fileName)
    }
