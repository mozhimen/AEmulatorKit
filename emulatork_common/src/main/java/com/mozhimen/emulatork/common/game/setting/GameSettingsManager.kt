package com.mozhimen.emulatork.common.game.setting
 ...
 * @Version 1.0
 */
open class GameSettingsManager(private val context: Context, sharedPreferences: Lazy<SharedPreferences>) {
    ...
    suspend fun cacheSizeBytes() = stringPreference(
        ...
        StorageCacheCleaner.getDefaultCacheLimit().toString()
    )
