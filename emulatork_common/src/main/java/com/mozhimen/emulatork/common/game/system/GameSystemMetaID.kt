 ...
 * @Version 1.0
 */
fun SystemBundle.metaSystemID() = GameSystemMetaID.fromSystemID(id)
...
enum class GameSystemMetaID(val titleResId: Int, val imageResId: Int, val systemIDs: List<ESystemType>) {
    NES(
    ...
    companion object {
        fun fromSystemID(systemID: ESystemType): GameSystemMetaID {
